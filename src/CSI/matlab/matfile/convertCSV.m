...
while(it <= 50) %파일개수에 따라 숫자를 달리 한다.
...
% C:\Users\KimYongHwan\Documents\GitHub\2019-cap1-2019_22\src\190528_Dataset2\sitdown*.dat
if(it<=9)
strt = sprintf('%s%d%s', 'C:\Users\KimYongHwan\Documents\GitHub\2019-cap1-2019_22\src\190528_Dataset2\walk0',it,'.dat');

else
strt = sprintf('%s%d%s', 'C:\Users\KimYongHwan\Documents\GitHub\2019-cap1-2019_22\src\190528_Dataset2\walk',it,'.dat');
